 ...
 * @author tanvi
 */
public class InteractWithNutritionistJPanel extends javax.swing.JPanel {

    /**
     * Creates new form InteractWithNutritionistJPanel
     */
    private UserAccount sender;
    private JSplitPane splitPane;
    private EcoSystem system;

    public InteractWithNutritionistJPanel(JSplitPane splitPane, UserAccount account, Organization organization, EcoSystem system) {
        initComponents();
    ...
    public void populateRequestTable() {
        ...
        for (WorkRequest request : sender.getWorkQueue().getWorkRequestNutritionList()) {
            ...
            String result = ((NutritionistWorkRequest) request).getResultMessage();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/nutrition.png"))); // NOI18N
        ...
        jLabel6.setText("Chat with a Nutritionist");
    ...
    private void btnSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendActionPerformed
            ...
            for(Enterprise enterprise: network.getEnterpriseDirectory().getEnterpriseList())
            {
                for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
                    if (organization instanceof NutritionistOrganization) {
                        orgn = organization;
                        if (orgn != null) {
                        orgn.getWorkQueue().getWorkRequestNutritionList().add(request);
                        sender.getWorkQueue().getWorkRequestNutritionList().add(request);
        ...
        //txtMessage.setText("");
        txtAgentName.setText("Nutritionist not assigned");
        populateRequestTable();
    ...
    private void btnRefreshActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRefreshActionPerformed
        ...
        txtReply.setText(((NutritionistWorkRequest) result).getResultMessage());
        if (((NutritionistWorkRequest) result).getReceiver() != null) {
            txtAgentName.setText(((NutritionistWorkRequest) result).getReceiver().getEmployee().getName());
        }
