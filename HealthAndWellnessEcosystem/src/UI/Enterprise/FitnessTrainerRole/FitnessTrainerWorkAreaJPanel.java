 ...
 */
package UI.Enterprise.FitnessTrainerRole;
...
public class FitnessTrainerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private FitnessTrainersOrganization organization;
    private Enterprise enterprise;
    private EcoSystem system;
    FitnessTrainerWorkRequest fitnessWorkRequest;

    public FitnessTrainerWorkAreaJPanel(JSplitPane splitPane, UserAccount account, Organization organization, Enterprise enterprise, EcoSystem system) {
        initComponents();
        this.splitPane = splitPane;
        this.account = account;
        this.organization = (FitnessTrainersOrganization) organization;
    ...
    public void populateTable() {
        ...
        model.setRowCount(0);
        for (WorkRequest request : organization.getWorkQueue().getWorkRequestFitnessList()) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Fitness Trainer Role");
    ...
    private void btnAcknActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcknActionPerformed
        ...
        if (selectedRow >= 0) {
            fitnessWorkRequest = (FitnessTrainerWorkRequest) tblWorkRequests.getValueAt(selectedRow, 0);

            fitnessWorkRequest.setStatus("Acknowledged");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        fitnessWorkRequest.setResultMessage(txtResolution.getText());
        fitnessWorkRequest.setStatus("Resolved");
        populateTable();
