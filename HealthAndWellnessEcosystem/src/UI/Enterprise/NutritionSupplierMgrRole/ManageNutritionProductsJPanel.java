 ...
 * @author tanvi
 */
public class ManageNutritionProductsJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManageNutritionProductsJPanel
     */
    ...
    public ManageNutritionProductsJPanel(NutritionSupplierOrganization supplier, JSplitPane splitPane, UserAccount account, Enterprise enterprise, EcoSystem system) {
        initComponents();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (selectedRow == -1) {
            ...
            UpdateNutritionProductsJPanel updateNutritionProductsJPanel = new UpdateNutritionProductsJPanel(splitPane, account, supplier, enterprise, system, selectedProduct);
            splitPane.setRightComponent(updateNutritionProductsJPanel);
        }
