...
//        Person xeroxadminperson001 = persondirectory.newPerson("Xerox admin","Admin");
...
//        EmployeeProfile employeeprofile0 = employeedirectory.newEmployeeProfile(null);


   
// Create User accounts that link to specific profiles
        //UserAccountDirectory uadirectory = business.getUserAccountDirectory();
        //UserAccount ua3 = uadirectory.newUserAccount(employeeprofile0, "admin", "XXXX", "admin", "active"); /// order products for one of the customers and performed by a sales person
